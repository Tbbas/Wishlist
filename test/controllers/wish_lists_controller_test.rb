...
class WishListsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create wish_list" do
    assert_difference('WishList.count') do
      post wish_lists_url, params: { wish_list: { description: @wish_list.description, name: @wish_list.name } }
    end
  ...
  test "should update wish_list" do
    patch wish_list_url(@wish_list), params: { wish_list: { description: @wish_list.description, name: @wish_list.name } }
